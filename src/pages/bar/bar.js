...
import BarSvgShape from '../../components/barChart/BarSvgShape';
...
class Bar extends Component {
  ...
  componentDidMount() {
    ...
    let barChart = new BarSvgShape();
    barChart.width = 450 + 40;
    barChart.height = 218;
    ref.barShapeRef.appendChild(barChart.domElement);
  }
};
